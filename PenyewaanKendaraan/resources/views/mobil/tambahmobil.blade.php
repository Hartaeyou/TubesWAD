                ...
                <div class="card-body">
                    <form action="{{ route('tambahmobil-baru') }}" method="POST">
                        ...
                        <div class="d-grid gap-2 col-10 mx-auto">
                            ...
                            <input type="text" class="form-control" id="brand" name="brand_mobil">
                        </div>
                        @error('content')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                        ...
                        <div class="d-grid gap-2 col-10 mx-auto">
                            ...
                            <input type="text" class="form-control" id="warna" name="warna_mobil">
                        </div>
                        @error('content')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                        ...
                        <div class="d-grid gap-2 col-10 mx-auto">
                            ...
                            <input type="text" class="form-control" id="plat" name="plat_mobil">
                        </div>
