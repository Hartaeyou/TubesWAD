...
<body>
    ...
    <h1 style="text-align : center;">Detail Mobil</h1>
                ...
                <div class="card-body">
                    <form>
                        <div class="d-grid gap-2 col-10 mx-auto">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama_mobil" readonly>
                        </div>

                        <div class="d-grid gap-2 col-10 mx-auto">
                            <label for="brand" class="form-label">Brand Mobil</label>
                            <input type="text" class="form-control" id="brand" name="brand_mobil" readonly>
                        </div>

                        <div class="d-grid gap-2 col-10 mx-auto">
                            <label for="warna" class="form-label">Warna Mobil</label>
                            <input type="text" class="form-control" id="warna" name="warna_mobil"readonly>
                        </div>

                        <div class="d-grid gap-2 col-10 mx-auto">
                            <label for="plat" class="form-label">Plat Mobil</label>
                            <input type="text" class="form-control" id="plat" name="plat_mobil"readonly>
                        </div>

                        <div class="d-grid gap-2 col-10 mx-auto">
                            <label for="plat" class="form-label">Mitra Mobil</label>
                            <input type="text" class="form-control" id="plat" name="mitra_mobil"readonly>
                        </div>
